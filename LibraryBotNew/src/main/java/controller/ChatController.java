...
public class ChatController {
    ...
    private void handleCekStok() {
        ...
        simulateTypingDelay(() -> {
            String response = chatbot.processInput("tampilkan buku yang tersedia");
    ...
    private void handleCariFiksi() {
        ...
        simulateTypingDelay(() -> {
            String response = "📚 KATEGORI: FIKSI\n\n" +
                    "Berikut adalah buku-buku fiksi yang tersedia:\n\n" +
                    "1. Laskar Pelangi\n   Oleh: Andrea Hirata\n   ✓ Tersedia (5 eksemplar)\n\n" +
                    "2. Bumi Manusia\n   Oleh: Pramoedya Ananta Toer\n   ✗ Stok Habis\n\n" +
                    "Ketik 'detail buku [judul]' untuk informasi lengkap.";
            addBotMessage(response);
        });
    }
    ...
    private void handleSemuaKatalog() {
        ...
        simulateTypingDelay(() -> {
            String response = chatbot.processInput("tampilkan semua katalog");
            addBotMessage(response);
        });
    }
    ...
    private void handleSemuaKategori() {
        ...
        simulateTypingDelay(() -> {
            String response = chatbot.processInput("tampilkan kategori");
            addBotMessage(response);
        });
    }
    ...
    private void handleProfileClick() {
        ...
        alert.setHeaderText("Ohim Nibos");
        alert.setContentText(
                "Nama: Ohim Nibos\n" +
                        "Email: ohim.nibos@gmail.com\n" +
                        "Status: Member Aktif\n" +
                        "Buku Dipinjam: 0"
        );
        alert.showAndWait();
