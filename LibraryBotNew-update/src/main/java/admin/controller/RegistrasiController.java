...
public class RegistrasiController {
    ...
    public void handleDaftar() {
        ...
        if (success) {
            ...
            alert.setHeaderText("Pendaftaran akun berhasil!");
            alert.setContentText(
                "Akun Anda telah terdaftar dengan status: Menunggu Konfirmasi.\n\n" +
                "Silakan tunggu hingga admin mengkonfirmasi akun Anda sebelum dapat login."
            );
            alert.showAndWait();
            goToLogin();
        } else {
